...
echo "cloning vendor"
git clone https://github.com/PixelOS-Devices/vendor_realme_porsche.git vendor/realme/porsche

echo "cloning common vendor"
git clone https://github.com/PixelOS-Devices/vendor_oneplus_sm8350-common.git vendor/oneplus/sm8350-common
